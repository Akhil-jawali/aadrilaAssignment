...
const Industires = () => {
    return (
        <>
            <div className="relative w-full md:mt-16 industryBg lg:h-[600px]">
                <div className="md:px-10 px-5 md:pb-5 md:pb-5 md:pt-0 pt-10">
                    <div className="flex flex-col z-20">
                        <p className="lg:text-2xl md:text-xl text-lg font-bold heroGradient manrope">
                            AI-driven innovation for growth.
                        </p>
                        <p className="md:mt-3 text-3xl md:text-4xl font-semibold lg:text-5xl">
                ...
                <div className="absolute top-0 right-0 w-full lg:px-16 px-5 py-5 lg:block hidden">
